...
extern DECL_EXP bool AddPlugInRoute2( PlugIn_Route *proute,const wxString& linecolor ,const int& linewidth,const wxPenStyle& linestyle,bool b_permanent = true );
